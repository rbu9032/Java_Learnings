...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        JdbcTemplate jdbcTemplate = container.getBean("getJdbcTemplate", JdbcTemplate.class);
       // jdbcTemplate.update("Insert into employee values(?,?,?)",3,"Ravi","ravi@gmail.com");
        //jdbcTemplate.update("Update employee set empId=? where name=?",2,"Ravi");
