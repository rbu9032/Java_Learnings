...
import com.rbu.restaurant.exception.OrderNotFoundException;
...
public class OrderServiceImpl implements OrderService {
	...
	public OrderResponseDto updateOrderStatus(long orderId, String status) {
		...
		OrderResponseDto orderResponseDto = OrderDtoBuilder.buildOrderResponseDtoFromOrder(order);
		String restaurantName = fetchRestaurantName(order);
		orderResponseDto.setRestaurantName(restaurantName);
		return orderResponseDto;
	}
